...
static void OnRxData(LmHandlerAppData_t *appData, LmHandlerRxParams_t *params)
{
  ...
  if (params != NULL)
  {
//TODO    HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, GPIO_PIN_SET); /* LED_BLUE */
        ...
        if (appData->Buffer != NULL)
        {
          switch (appData->Port)
          {
            ...
            case LORAWAN_USER_APP_PORT:
              ...
              //TODO    HAL_GPIO_WritePin(LED3_GPIO_Port, LED3_Pin, GPIO_PIN_RESET); /* LED_RED */
                }
                else
                {
                  APP_LOG(TS_OFF, VLEVEL_H, "LED ON\r\n");
                  //TODO  HAL_GPIO_WritePin(LED3_GPIO_Port, LED3_Pin, GPIO_PIN_SET); /* LED_RED */
                }
              }
              break;
...
static void OnTxTimerLedEvent(void *context)
{
	//TODO HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, GPIO_PIN_RESET); /* LED_GREEN */
}

static void OnRxTimerLedEvent(void *context)
{
	//TODO HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, GPIO_PIN_RESET); /* LED_BLUE */
}

static void OnJoinTimerLedEvent(void *context)
{
	//TODO HAL_GPIO_TogglePin(LED3_GPIO_Port, LED3_Pin); /* LED_RED */
}
...
static void OnTxData(LmHandlerTxParams_t *params)
{
  ...
  if ((params != NULL))
  {
    ...
    {
    	//TODO HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, GPIO_PIN_SET); /* LED_GREEN */
